...
Ported from temporal-sa/ai-agents-webinar by way of the Python track. The host
map is scoped to what the Java sandbox actually reaches: the Gradle
distribution service, Maven Central and the Gradle plugin portal, GitHub, and a
request-echo service used to prove the proxy is in the path.
