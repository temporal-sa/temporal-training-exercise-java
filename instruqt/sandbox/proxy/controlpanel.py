...
Ported from temporal-sa/ai-agents-webinar by way of the Python track. Flipping a toggle off makes
...
SERVICE_LABELS = {
    "maven":   "Maven Central and Gradle  (repo1.maven.org, services.gradle.org)",
